...
func Test_WriteManifest_Success(t *testing.T) {
	...
	err := WriteManifest(fs, "/data/test"+schema.Par2Extension+schema.ManifestExtension, mf, false)
...
func Test_WriteManifest_UpdatesManifestVersion_Success(t *testing.T) {
	...
	err := WriteManifest(fsys, "/data/test"+schema.ManifestExtension, mf, false)
	require.NoError(t, err)
