...
func newVerifyCmd(ctx context.Context) *cobra.Command {
	...
	verifyCmd.Flags().StringVar(&verifyOptions.CacheDir, "cache", "", "directory for optional manifest cache (works best on fast storage)")
...
func newRepairCmd(ctx context.Context) *cobra.Command {
	...
	repairCmd.Flags().StringVar(&repairOptions.CacheDir, "cache", "", "directory for optional manifest cache (works best on fast storage)")
...
func newInfoCmd(ctx context.Context) *cobra.Command {
	...
	infoCmd.Flags().StringVar(&infoOptions.CacheDir, "cache", "", "directory for optional manifest cache (works best on fast storage)")
